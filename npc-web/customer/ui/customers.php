                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button onclick="location.href='addCustomer.php'" class="btn green"> Add New
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="none">Customer Type</th>
                                                <th class="none">Address</th>
                                                <th class="none">Username</th>
                                                <th class="desktop">Password</th>
                                        ...
                                        foreach ($customerDao->getCustomers() as $row) {
                                            echo '<tr>';
                                            ...
                                            echo "<td>".$row['customerImagePath']."</td>";
                                            echo "<td>Edit</td>";
                                            echo "<td>Delete</td>";
                                            echo '</tr>';
                                        }
